...
#define UCPD_CC_DETECTION_ONLY(mask) WRITE_REG(mask, UCPD_IMR_TYPECEVT1IE | UCPD_IMR_TYPECEVT2IE)

#define UCPD_INT_NORMAL_MASK                                                                                           \
	UCPD_IMR_TYPECEVT1IE | UCPD_IMR_TYPECEVT2IE | UCPD_IMR_RXMSGENDIE | UCPD_IMR_RXHRSTDETIE | UCPD_IMR_RXORDDETIE |   \
	    UCPD_IMR_HRSTSENTIE | UCPD_IMR_TXMSGSENTIE | UCPD_IMR_TXMSGDISCIE
...
#define UCPD_CC_CHECK_TX_OK(status, pin) ((status & UCPD_SR_TYPEC_VSTATE_##pin) == LL_UCPD_SNK_##pin##_VRP30A)
